 ...
 * on 2016-01-03 at 00:30:24 UTC 
 * Modify at your own risk.
 */

package com.saurabh.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayHi extends MyApiRequest<com.saurabh.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.saurabh.backend.myApi.model.MyBean.class);
  ...
  /**
   * Create a request for the method "tellAJoke".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link TellAJoke#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public TellAJoke tellAJoke() throws java.io.IOException {
    TellAJoke result = new TellAJoke();
    initialize(result);
    return result;
  }

  public class TellAJoke extends MyApiRequest<com.saurabh.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "tellAJoke";

    /**
     * Create a request for the method "tellAJoke".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link TellAJoke#execute()} method to invoke the remote operation. <p>
     * {@link
     * TellAJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
    ...
    @Override
    public TellAJoke setAlt(java.lang.String alt) {
      return (TellAJoke) super.setAlt(alt);
    }

    @Override
    public TellAJoke setFields(java.lang.String fields) {
      return (TellAJoke) super.setFields(fields);
    }

    @Override
    public TellAJoke setKey(java.lang.String key) {
      return (TellAJoke) super.setKey(key);
    }

    @Override
    public TellAJoke setOauthToken(java.lang.String oauthToken) {
      return (TellAJoke) super.setOauthToken(oauthToken);
    }

    @Override
    public TellAJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (TellAJoke) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public TellAJoke setQuotaUser(java.lang.String quotaUser) {
      return (TellAJoke) super.setQuotaUser(quotaUser);
    }

    @Override
    public TellAJoke setUserIp(java.lang.String userIp) {
      return (TellAJoke) super.setUserIp(userIp);
    }

    @Override
    public TellAJoke set(String parameterName, Object value) {
      return (TellAJoke) super.set(parameterName, value);
    }
  }
